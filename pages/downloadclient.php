															...
															<table class="TableContent" width="100%">
																<tr>
																	...
																	<center><h1>Official '.$config['server']['serverName'].' Client</h1></center>
																			<tr>
																				<td>
																					<img style="width: 90; height: 90px; border: 0px;" src="'.$layout_name.'/images/account/TieteOT.png"/>
																				</td>																				
																			</tr>
																			<tr>
																			<td valign="top">
																					<a href="http://tiete.servegame.com:8090/Setup TieteOT.exe" target="_blank" type="application/octet-stream" target="_top">Download Tibia 12.61<br/>Windows Client</a>
																				</td>																				
																			</tr>																			
																			<tr>
													...
													<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif)">
														<div class="TableContentContainer">
															<table class="TableContent" width="100%">
																<tr>
																	<td><table style="width:100%;text-align:center">
																	<center><h1>Virus Total Analysis</h1></center>
																			<tr>
																				<td>
																					<img style="width: 90; height: 90px; border: 0px;" src="'.$layout_name.'/images/account/VT.png"/>
																				</td>																				
																			</tr>
																			<tr>
																			<td valign="top">
																					<a href="https://www.virustotal.com/gui/file/44d151e7f8101a7f41484d981cc73eaac3a333fed69fd0df12a8a766d06083c6/detection" target="_blank" type="application/octet-stream" target="_top">Click Here To<br>Check</a>
																				</td>																				
																			</tr>																			
																			<tr>
																				<td colspan="2" >&nbsp;</td>
