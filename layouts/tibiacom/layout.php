...
<body onbeforeunload="SaveMenu();"
      style="background-image:url(<?php echo $layout_name; ?>/images/global/header/bg_101.jpg);
              background-size: 100%;
                            ...
                            <div id="ContentHelper">
                                <div id="preload">
                                    ...
                                    <div id="PlayersOnline" class="Box">
                                        ...
                                        <div class="BorderTitleText" style="background-image:url(layouts/tibiacom/images/global/content/title-background-black.gif); height: 28px;">
                                            <div class="InfoBar">
...
<?php echo $cast1; ?>
                                    ...
                                    <div id="NewsArchive" class="Box">
                                        ...
                                        <div class="BorderTitleText" style="background-image:url(<?php echo $layout_name; ?>/images/global/content/title-background-black.gif);"></div>
                                        <?php
...
<?php }?>   
	<!-- float discord start -->
	<script id="float_discord" src="<?php echo $layout_name; ?>/js/discord/discord_float_plugin.js" data-id="810600166486704169&theme=dark"></script>
	<!-- float discord end --> 
<script src="<?php echo $layout_name; ?>/js/ouibounce.min.js<?php echo $css_version;?>"></script>
