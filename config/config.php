...
$config['site']['realurl'] = "http://tiete.servegame.com:8090/"; // Put the real url for your website without www DO NOT FORGET FROM / AT THE END
$config['site']['realurlwww'] = "http://tiete.servegame.com:8090/"; // Put the real url for your website with www IF IT IS A SUBDOMINUM PUT THE MSM URL OF THE REAL URL
$config['site']['testurl'] = "http://tiete.servegame.com:8090/"; // Put the url you use to test your site (LOCALHOST)
/** END SERVER URLS */
...
$config['site']['gRecaptchaSecret'] = "6LeZsuMZAAAAANP1AwFT5mruA4tjx1fRRZjoWpJq";
$config['site']['gRecaptchaSiteKey'] = "6LeZsuMZAAAAADRKQmRQQM-6fije5TKVOxmUZobF";
...
$config['site']['sqlPass'] = "ctdogk4p.";
$config['site']['sqlBD'] = "otserver";

# Characters animatedOutfits php
$config['site']['animatedOutfits_url'] = 'http://tiete.servegame.com:8090/AnimatedOutfits/animoutfit.php?';
$config['site']['outfit_images_url'] = 'http://tiete.servegame.com:8090/AnimatedOutfits/outfit.php?';
...
$config['site']['mail_senderName'] = "TieteOT Server";
$config['site']['smtp_enabled'] = true;
$config['site']['smtp_host'] = "smtp.gmail.com";
$config['site']['smtp_port'] = 587;
$config['site']['smtp_auth'] = true;
$config['site']['smtp_user'] = "TieteOT@gmail.com";
$config['site']['smtp_pass'] = "TieteOT123.";
...
$config['site']['landpage_title'] = "Teste";
$config['site']['landpage_timeout'] = 60 * 10080; // Time in seconds 1 * 60 = 1 minute
$config['site']['landpage_description'] = "Teste"; // Type text here to appear on the landpage
...
/** HIGH SCORES CONFIG */
$config['site']['h_limit'] = 100; // Limit players per page
$config['site']['h_limitOffset'] = 2000; // Limits the maximum number of players in the rank
...
/** PICPAY CONFIGS */
$config['picpay']['user'] = 'f.sanches'; //User no having @
